...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title> @yield('title', 'BLACKFORDBY COLLEGE OF AGRICULTURE') </title>
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="{{url('/admin')}}">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <p class="logo-text ms-2 d-none d-sm-block">BLACKFORDBY COLLEGE OF AGRICULTURE</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <footer class="footer position-absolute">
                <div class="row g-0 justify-content-between align-items-center h-100">
                    <div class="col-12 col-sm-auto text-center">
                        <p class="mb-0 mt-2 mt-sm-0 text-900">BLACKFORDBY COLLEGE OF AGRICULTURE<span
