...
<div class="container-fluid mt-4">
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0">Edit Disciplinary Record</h6>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('students.disciplinaries.update', ['student' => $student, 'disciplinary' => $disciplinary]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <!-- Incident Date -->
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('incident_date', date('Y-m-d', strtotime($disciplinary->incident_date))) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="incident_type" class="form-select @error('incident_type') is-invalid @enderror">
                            ...
                            @foreach(\App\Models\StudentDisciplinary::INCIDENT_TYPES as $value => $label)
                                <option value="{{ $value }}" {{ old('incident_type', $disciplinary->incident_type) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="3"
                                  placeholder="Enter incident description">{{ old('description', $disciplinary->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('reported_by', $disciplinary->reported_by) }}"
                        ...
                        <div id="witnesses-container">
                            @php
                                $witnesses = old('witnesses') ?? 
                                            (is_string($disciplinary->witnesses) ? 
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="action_taken" 
                                  ...
                                  rows="3"
                                  placeholder="Enter action taken">{{ old('action_taken', $disciplinary->action_taken) }}</textarea>
                        @error('action_taken')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="sanction" class="form-select @error('sanction') is-invalid @enderror">
                            ...
                            @foreach(\App\Models\StudentDisciplinary::SANCTIONS as $value => $label)
                                <option value="{{ $value }}" {{ old('sanction', $disciplinary->sanction) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('start_date', $disciplinary->start_date ? date('Y-m-d', strtotime($disciplinary->start_date)) : '') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('end_date', $disciplinary->end_date ? date('Y-m-d', strtotime($disciplinary->end_date)) : '') }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror">
                            ...
                            @foreach(\App\Models\StudentDisciplinary::STATUSES as $status)
                                <option value="{{ $status }}" {{ old('status', $disciplinary->status) == $status ? 'selected' : '' }}>
                                    {{ Str::title($status) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" 
                                  ...
                                  rows="3"
                                  placeholder="Enter additional notes">{{ old('notes', $disciplinary->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Update Disciplinary Record
                            </button>
                        </div>
                    </div>
                </div>
