        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-user-plus text-primary me-2"></i>Add Next of Kin
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('students.next-of-kin.store', $student) }}" method="POST">
                        @csrf
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Save Next of Kin
                            </button>
