            ...
            <form action="{{ route('students.identifications.update', ['student' => $student, 'identification' => $identification]) }}" 
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="issuing_country_id" 
                                class="form-select @error('issuing_country_id') is-invalid @enderror"
                                required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            ...
                            <option value="active" {{ old('status', $identification->status) == 'active' ? 'selected' : '' }}>Active</option>
                            <option value="expired" {{ old('status', $identification->status) == 'expired' ? 'selected' : '' }}>Expired</option>
                            <option value="pending_verification" {{ old('status', $identification->status) == 'pending_verification' ? 'selected' : '' }}>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" 
                                  ...
                                  rows="3"
                                  placeholder="Enter any additional notes">{{ old('notes', $identification->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
