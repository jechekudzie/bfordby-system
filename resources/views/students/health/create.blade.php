...
<div class="container-fluid mt-4">
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0">Add Health Information</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('students.health.store', $student) }}" method="POST">
                @csrf
                <div class="row g-3">
                    <!-- Blood Group -->
                    <div class="col-md-6">
                        ...
                        <select name="blood_group" class="form-select @error('blood_group') is-invalid @enderror">
                            ...
                            @foreach($bloodGroups as $value => $label)
                                <option value="{{ $value }}" {{ old('blood_group') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-start gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Save Health Information
                            </button>
