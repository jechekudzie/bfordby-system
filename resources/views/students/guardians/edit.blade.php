...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0">Edit Guardian</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('students.guardians.update', ['student' => $student, 'guardian' => $guardian]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="contact_details" 
                                  ...
                                  rows="1">{{ old('contact_details', $guardian->contact_details) }}</textarea>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-start gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Update Guardian
                            </button>
