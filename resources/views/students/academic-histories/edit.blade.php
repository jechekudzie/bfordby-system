...
<div class="container-fluid mt-4">
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0">Edit Academic History</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('students.academic-histories.update', [$student->slug, $academicHistory->slug]) }}" 
                  method="POST" 
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('institution_name', $academicHistory->institution_name) }}"
                        ...
                        <select name="qualification_level_id" class="form-select @error('qualification_level_id') is-invalid @enderror">
                            ...
                            @foreach($qualificationLevels as $level)
                                <option value="{{ $level->id }}" 
                                    {{ old('qualification_level_id', $academicHistory->qualification_level_id) == $level->id ? 'selected' : '' }}>
                                    {{ $level->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('program_name', $academicHistory->program_name) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('start_date', date('Y-m-d', strtotime($academicHistory->start_date))) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('completion_date', date('Y-m-d', strtotime($academicHistory->completion_date))) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('grade_achieved', $academicHistory->grade_achieved) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('certificate_number', $academicHistory->certificate_number) }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror">
                            ...
                            @foreach(['completed', 'in_progress', 'incomplete', 'verified'] as $status)
                                <option value="{{ $status }}" 
                                    {{ old('status', $academicHistory->status) == $status ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($academicHistory->certificate_path)
                            <div class="mt-2">
                                <a href="{{ Storage::url($academicHistory->certificate_path) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        @if($academicHistory->transcript_path)
                            <div class="mt-2">
                                <a href="{{ Storage::url($academicHistory->transcript_path) }}" 
                                   class="btn btn-sm btn-outline-secondary" 
                                   target="_blank">
                                    <i class="fas fa-eye me-1"></i>View Current Transcript
                                </a>
                            </div>
                        @endif
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" 
                                  ...
                                  rows="3"
                                  placeholder="Enter any additional notes">{{ old('notes', $academicHistory->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-start gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Update Academic History
                            </button>
